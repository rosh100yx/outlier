...
\hypersetup{
  ...
  pdfsubject={AI Safety, Carbon Footprint, Software Engineering, Global South, Data Sovereignty},
  pdfkeywords={AI Safety, Carbon Footprint, Software Engineering, Global South, Deskilling, Authorship Verification, Data Sovereignty, AI Governance},
  colorlinks=true,
  linkcolor=blue,
  citecolor=blue,
  urlcolor=blue,
...
\pdfinfo{
  ...
  /Subject (AI Safety and Governance)
  /Keywords (AI Safety, Carbon Footprint, Software Engineering, Global South, Deskilling, Authorship Verification, Data Sovereignty, AI Governance)
}

\title{Measuring AI Use: A Governance Framework for Carbon, Authorship Erosion, and AI Adoption}

\author[1]{Roshan Abraham}
\affil[1]{Independent Researcher and UX Design Engineer, Ho Chi Minh City, Vietnam}
%\affil[2]{Corresponding author: \href{mailto:...}{...}}
...
\vspace{0.5em}
\noindent\textbf{Keywords.} AI Safety; Carbon Footprint; Software Engineering; Global South; Deskilling; Authorship Verification; Data Sovereignty; AI Governance
\end{abstract}
...
This problem is particularly acute in software engineering. A developer who asks AI to write code consumes electricity and simultaneously reduces their own engagement with the work. Existing governance frameworks treat these as separate problems. However, at the developer's computer, they are a single event.
